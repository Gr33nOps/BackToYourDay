    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
        ...
        <div className="md:col-span-7 text-left space-y-5">
          ...
          <div className="grid grid-cols-2 border-t border-b border-surface-border py-3 text-xs font-mono divide-x divide-surface-border">
            <div className="pr-3">
              <span className="text-[10px] text-foreground-dim block uppercase">Classification</span>
              <span className="text-white font-semibold text-sm">Natural Gemstone</span>
            </div>
            <div className="pl-3">
              <span className="text-[10px] text-foreground-dim block uppercase">Tradition</span>
              <span className="text-white font-semibold text-sm">Gregorian Almanac</span>
            </div>
          </div>
