        ...
        <div className="md:col-span-7 text-left space-y-5">
          ...
          <div className="grid grid-cols-2 border-t border-b border-surface-border py-3 text-xs font-mono divide-x divide-surface-border">
            <div className="pr-3">
              ...
              <span className="text-white font-semibold text-sm">Language of Flowers</span>
            </div>
            <div className="pl-3">
              <span className="text-[10px] text-foreground-dim block uppercase">Attribute</span>
              <span className="text-white font-semibold text-sm">{flower.meaning}</span>
            </div>
          </div>
