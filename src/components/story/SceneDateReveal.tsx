      ...
      >
        ...
        <div className="overflow-hidden">
          <motion.div
            ...
            className="font-display font-black text-white/25 leading-[0.88] tracking-tight"
        ...
        {stats.length > 0 && (
          ...
          >
            {stats.map(s => (
              ...
              >
                <span className="font-mono text-[9px] uppercase tracking-widest text-white/25">{s.label}</span>
                <span className="font-mono text-[11px] font-semibold text-white/70">{s.val}</span>
              </div>
            ))}
          </motion.div>
        )}
